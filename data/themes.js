...
window.SENTENCES = [
 ...
 Z({id:'s_hart10', labels:['hart'], bm:{nb:'Får jeg massere ryggen din?', ph:'fohr jai ma-SEE-re RUG-gn dien?'}, nb:'Får eg massere ryggen din?', nl:'Mag ik je rug masseren?', ph:'fohr eeg ma-SEE-re RUG-gn dien?', phNL:'makh ik jə rukh ma-SEE-rən?',
